 ...
 */
public class VkLoginWindow extends Window {
	@Override
	protected void initPanel() {
		...
		label.setText("Enter access_token which is in browser's address bar");
		...
		loginButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				try {
					VkManager.getInstance().continueLogin(field.getText());
				} catch (Exception err) {
					Log.e("MainWindow", "Can't continue login in vk", err);
				}
			}
		});
